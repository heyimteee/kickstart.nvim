-- Flutter/Dart development: device management, hot reload, LSP integration.
-- All Flutter commands are under the <leader>F prefix.
...
return {
  ...
  config = function()
    ...
    map('n', '<leader>FL', '<cmd>FlutterLogToggle<cr>', { desc = 'Flutter: Toggle Log' })
